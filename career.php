...
<div class="container cc-margin-bottom-60">
	...
	<section class="tourb2-ab-p-2 com-colo-abou" >
		<div class="container">
			<!-- TITLE & DESCRIPTION -->
			<div class="spe-title">
				<h2>See Our <span>Openings</span></h2>
				<div class="title-line">
					<div class="tl-1"></div>
					<div class="tl-2"></div>
					<div class="tl-3"></div>
				</div>
				<p>You are smart, driven and want to make a difference in the world. You will fit right in.</p>
			</div>
			<div class="row tourb2-ab-p1" style="margin-bottom: 30px;">
				<div class="col-md-8 col-sm-6 col-xs-12">
					<div class="accordion" id="accordionExample">
					  <div class="card">
					    ...
					    <div id="collapseOne" class="show collapse in" aria-labelledby="headingOne" data-parent="#accordionExample">
					      <div class="card-body">
					        <div class="tourb2-ab-p1-left">
								<h3>Asst. Sales Manager</h3> <span>Role : Asst. Sales Manager<br>Location : <br>Experience : Minimum 00 months<br>Salary : 00 INR + Incentives</span> <br> <br>

								<p><strong style="color: #253d52;">Responsibilities :</strong><br>We are looking for a Travel Consultant, who is passionate about traveling. You will manage travel requirements made for holidays and will provide tourism related services and package tours . The goal is to keep our clients satisfied and loyal for future services.</p>

								<p><strong style="color: #253d52;">Brief :</strong><br>We are looking for a Travel Consultant, who is passionate about traveling. You will manage travel requirements made for holidays and will provide tourism related services and package tours . The goal is to keep our clients satisfied and loyal for future services.</p>

								<p><strong style="color: #253d52;">Requirement :</strong><br>We are looking for a Travel Consultant, who is passionate about traveling. You will manage travel requirements made for holidays and will provide tourism related services and package tours . The goal is to keep our clients satisfied and loyal for future services.</p>
							</div> 
					      </div>
					    </div>
					  </div>
					  <div class="card">
					    ...
					    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
					      <div class="card-body">
					        <div class="tourb2-ab-p1-left">
								<h3>Sales Manager</h3> <span>Role : Asst. Sales Manager<br>Location : <br>Experience : Minimum 00 months<br>Salary : 00 INR + Incentives</span> <br> <br>
					  ...
					  <div class="card">
					    ...
					    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
					      <div class="card-body">
					        <div class="tourb2-ab-p1-left">
								<h3>Content Writer</h3> <span>Role : Asst. Sales Manager<br>Location : <br>Experience : Minimum 00 months<br>Salary : 00 INR + Incentives</span> <br> <br>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="tr-regi-form v2-search-form contformbody">
				<h3 class="text-center">Apply Now</h3>
                        <form id="careerRequest" class="contactform" name="contactform" method="post">
							<div class="row">
								<div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    <input type="submit" value="Apply Now" class="frmBtn">
                                </div>
                            </div>	
						</form>
					</div>
...
$mobile = selectQuery(VLIST,"*","(device='android' OR device='Windows Phone') AND device<>''"); ?-->
	...
	$(document).ready(function(){
      $('#careerRequest').submit(function(e){
      	// alert($("#careerRequest").serialize());
          $.ajax({
                        type: "POST",
                        url: "mail/careerRequestSubmit.php",
                        data: $("#careerRequest").serialize(),
                        success: function(data) {
                           // location.reload();
                           // reset_form('careerRequest');
                           $('#careerRequest').html(data);
                        }
          });
          e.preventDefault();
        });
