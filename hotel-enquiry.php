            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-md-offset-2 contformbody">
                        ...
                        <form id="hotelEnq" class="contactform" name="contactform" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <input type="text" id="from" name="from" placeholder="Check In DateArrival Date" autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <input type="text" id="to" name="to" placeholder="Check Out Date" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
$("#to").datetimepicker({ timepicker:false, format:'d-m-Y' });
    ...
    $(document).ready(function(){
      $('#hotelEnq').submit(function(e){
        // alert($("#hotelEnq").serialize());
          $.ajax({
                        type: "POST",
                        url: "mail/hotelEnquirySubmit.php",
                        data: $("#hotelEnq").serialize(),
