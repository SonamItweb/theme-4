        ...
        <div class="row cc-margin-bottom-60">
            <div class="site_map">
                    <div class="col-md-3 col-sm-3">
                        <ul>
                            <li> <a href="packages.php">Tour Packages</a>
                                <ul>
                                    <?php 
                    ...
                    <div class="col-md-3 col-sm-3">
                        <ul>
                            <li> <a href="group-package.php">Group Tours</a>
                                <ul>
                                    <?php
                                        $sq_tours = mysql_query("select tour_id,tour_name from tour_master where active_flag='Active'");
                                        while($row_tour = mysql_fetch_assoc($sq_tours)){
                                        ?>
                                            <li><a href="group-tour-detail.php?id=<?=  $row_tour[tour_id] ?>"><?=  $row_tour['tour_name'] ?></a></li>
                                        <?php  } ?>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-3 col-sm-3">
                        <ul>
                            ...
                            <li><a href="discount.php">Offers</a> </li>
                            <li><a href="enquiry.php">Tour Enquiry</a> </li>
                            <li><a href="hotel-enquiry.php">Hotel Enquiry</a> </li>
                            <li><a href="activity-enquiry.php">Activity Enquiry</a> </li>
