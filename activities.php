...
$('#city_id_filter').select2();
    ...
    {
      $('#div_activity_list').append('<div class="loader"></div>');
        var city_id = $('#city_id_filter').val();
        $.post('dataReflect/activity_reflect.php', { city_id : city_id }, function(data){
            $('#div_activity_list').html(data);
        });
    }
    list_reflect();
</script>
