...
<div class="trendingNow cc-home-sec-padd paddTop">
    <div class="container">
        <div class="row cc-margin-bottom-60">
            <div class="col-sm-6">
                <img src="img/projectimage/holiday-cruise.jpg" alt="holiday-cruise with Life Holidays" class="img-responsive m-auto" width="470" height="365">
            </div>
            <div class="col-sm-6"><img src="img/projectimage/holiday-cruise.jpg" alt="holiday-cruise with Life Holidays" class="img-responsive m-auto" width="470" height="365"></div>
        </div>
    </div>
</div>
