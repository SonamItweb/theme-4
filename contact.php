...
<div class="content">
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            <h3 class="text-primary cc-margin-0">Let's have a call!</h3>
            <div class="row">
    <div class="col-sm-5 col-md-5 company-add" itemscope itemtype="http://schema.org/Organization">
        <h4 class="page-header"><b>CONTACT INFORMATION</b></h4>
        <div class="contdet" itemscope itemtype="http://schema.org/PostalAddress">
            <i class="fa fa-home" aria-hidden="true"></i> <?= $adminDetail['app_address'] ?></div>
        <div class="contdet">
            <i class="fa fa-phone" aria-hidden="true"></i> Holidays <br> (<?= $contCode['phone_code'] ?>) - <?= $adminDetail['app_contact_no'] ?> / <?= $adminDetail['app_landline_no'] ?>
        </div>
        <div class="contdet">
            <i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:mytestmail@gmail.com" class="contact-icon">Email: <?= $adminDetail['app_email_id'] ?></a>        
        </div>
    </div>
    <div class="col-sm-7 col-md-7 contformbody">
        <h4 class="page-header"><b>CONTACT FORM</b></h4>
        <div class="msgs"></div>
        <div class="emlerr"></div>
        <div class="teleerr"></div>
        <div class="text-center"> </div>
        <form id="contactFrm" class="contactform" name="contactform" method="post">
            <div class="row">
                <div class="col-xs-12">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.5943630468882!2d73.81561331489316!3d18.54722398739348!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf6b10270389%3A0x4e3787f9f3691ed!2sLife+Holidays+%26+Cruises+Pvt+Ltd.!5e0!3m2!1sen!2sin!4v1506150997299" class="contactmap" allowfullscreen itemprop="mapType" ></iframe>
...
$mobile = selectQuery(VLIST,"*","(device='android' OR device='Windows Phone') AND device<>''"); ?-->
    ...
    $(document).ready(function(){
      $('#contactFrm').submit(function(e){
        // alert($("#contactFrm").serialize());
          $.ajax({
                        type: "POST",
                        url: "mail/contactFrmSubmit.php",
                        data: $("#contactFrm").serialize(),
                        success: function(data) {
                           // location.reload();
                           // reset_form('contactFrm');
                           $('#contactFrm').html(data);
                        }
          });
          e.preventDefault();
        });
