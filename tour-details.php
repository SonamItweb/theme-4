...
$currency = mysql_fetch_assoc(mysql_query("select * from currency_name_master where id=$sq_package[currency_id]"));
$sq_dest = mysql_fetch_assoc(mysql_query("select * from destination_master where dest_id=$sq_package[dest_id]"));
$sq_package_program = mysql_query("select * from group_tour_program where tour_id = $package_id");
?>
<head>
    <title> </title>
    <meta charset='UTF-8'>
    ...
    <div class="inner-banner weave-border pkglist-poster">
        <div class="bannerTitle">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="text-center">Holiday Package</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row" itemscope itemtype="http://schema.org/Product">
                <div class="col-md-6">
                    <span class="tourCode text-muted small">
                        Package Code : <?= $sq_package['package_code']?> </span>
                    <h1 class="holidayName margintop0 cc-default-color" itemprop="name" id="tourname"><?= $sq_package['total_nights'].'N/'.$sq_package['total_days'].'D' ?></h1>
                    <h2 class="cc-margin-0 cc-font-size-25 cc-font-weight-8"><?= $sq_package['package_name']?></h2>
                ...
                <div class="col-md-2">
                    <div class="holidayCost">
                        ...
                        <div class="primaryColor pkg-last-price" itemscope itemtype="http://schema.org/Offer"><b
                                itemprop="price"><?= $currency['currency_code']?> <?= number_format($sq_package['adult_cost'], 0, ' ', '');?>/-</b></div>
                    </div>
                </div>
                    ...
                    <div class="holidayTab">
                        <ul class="nav nav-tabs" id="myTabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#hotel" id="hotel-tab" role="tab" data-toggle="tab"
                                    aria-controls="home" aria-expanded="true">Hotel</a></li>
                    ...
                    <div class="tour_head">
                        <div class="tour_right tour_incl tour-ri-com">
                            ...
                            <div class="">
                                <div class="">
                                         <div class="table-responsive">
                                            <table id="tbl_dynamic_bus_booking" name="tbl_dynamic_bus_booking" class="table noMarg table-bordered">
