...
<div class="inner-banner weave-border pkglist-poster">
        <div class="bannerTitle">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="text-center">Tips Before Travel</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row cc-margin-bottom-60">
            ...
            <div class="col-sm-6 col-md-5 col-md-offset-1 col-md-pull-5">
                 ...
                 <p class="cc-font-size-17">Cruising is strongly recommended for couples, and families who are looking for a relaxed holiday experience. Renowned cruise liners have itineraries all across the globe. Come, experience a different way of holidaying.</p><br>
            </div>
        </div>
