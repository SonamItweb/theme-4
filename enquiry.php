            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <div class="col-sm-8 col-md-8 col-md-offset-2 contformbody">
                        ...
                        <form id="tourEnq" class="contactform" name="contactform" method="post">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <input type="text" id="select-city-1" class="autocomplete validate" name="city" placeholder="Select City or Place">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <select id="dest_name_s" name="destination" title="Select Destination" style="text-align: left;width: 100%" required> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <input type="text" id="to" name="departure" placeholder="Departure Date" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    <div class="input-style-1 type-2 color-2">
                                        <select name="noOfChildrens" required>
...
$("#to").datetimepicker({ timepicker:false, format:'d-m-Y' });

    $(document).ready(function(){
      $('#tourEnq').submit(function(e){
        // alert($("#tourEnq").serialize());
          $.ajax({
                        type: "POST",
                        url: "mail/enquirySubmit.php",
                        data: $("#tourEnq").serialize(),
