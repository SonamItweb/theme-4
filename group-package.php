...
<body>
    ...
    <div class="inner-banner weave-border pkglist-poster">
        <div class="bannerTitle">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <h3 class="text-center">Group Tours</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container">
            <input type="hidden" id="categry" value="3" />
            <input type="hidden" id="subcategry" value="23" />
            <div class="row">
                <div class="col-md-8 col-md-offset-2 col-xs-12">
                <?php
                $sq_tours = mysql_query("select * from tour_master where active_flag='Active'");
                while($row_tour = mysql_fetch_assoc($sq_tours)){
                    $sq_day_count = mysql_num_rows(mysql_query("select * from group_tour_program where tour_id = $row_tour[tour_id]"));
                ...
                ?>
                    <div class="packagelistload">
                        <div class="productlist row">
                            <div class="pachage-preview col-sm-12 col-md-12">
                                <div class="card pkg-list-card marginbottom0">
                                    <div class="media">
                                        <div class="media-left pkg-med-left">
                                            <div class="package-thumb text-center">
                                                <a href="group-tour-detail.php?id=<?=  $row_tour[tour_id] ?>" class="black">
                                                <?php
                                                 $img = "http://itourscloud.com/destination_gallery/asia/singapore/Asia_Singapore_Four.jpg";
                                                 $sq_package_program = mysql_fetch_assoc(mysql_query("select daywise_images from group_tour_program where tour_id = $row_tour[tour_id]"));
                                                   $img = $sq_package_program['daywise_images'] ;
                                                ?>
                                                    <img src="<?= $img ?>"
                                                        class="media-object">
                                                </a>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-sm-offset-6 col-md-7 col-md-offset-5">
                                        <div class="row margin0 viewDetails">
                                            <a href="group-tour-detail.php?id=<?=  $row_tour[tour_id] ?>" class="btn btn-primary col-xs-6 col-sm-6 col-md-6">View Package</a>
