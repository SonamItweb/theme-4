    ...
    <div class="content">
        <div class="container">
            ...
            <div class="search-top">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3" style="margin-bottom: 40px;">
...
$('#city_id_filter').select2();
    function list_reflect()
    {
      $('#div_hotels_list').append('<div class="loader"></div>');
        ...
        $.post('dataReflect/hotel_reflect.php', { city_id : city_id }, function(data){
    ...
    {
        $.post('dataReflect/hotel_modal.php', {entry_id : entry_id}, function(data){
            $('#div_hotel_modal').html(data);
        });
        // alert("hello");
    }
</script>
